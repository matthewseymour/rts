var spriteTeamDepthVertexSource = `
...
uniform vec2 u_texTeamPosition;
...
void main() {
	...
	//convert from 0,0->1,1 to pixel positions:
	vec2 texTeamPixelPos = a_texCoord * u_texSize + u_texTeamPosition; 

	//convert the rectangle from pixels to 0.0 to 1.0
	v_texTeamCoord = texTeamPixelPos / u_texResolution;
